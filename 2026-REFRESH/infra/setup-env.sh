...
echo "     • Lab 0: Introduction (labs/0-introduction.ipynb)"
echo "     • Lab 1: Agent Red Teaming (labs/1-scan-agent/)"
echo "     • Lab 2: Model Red Teaming (labs/2-scan-model/)"
echo "     • Lab 3: Cloud Red Teaming (labs/3-scan-cloud/)"
echo ""
